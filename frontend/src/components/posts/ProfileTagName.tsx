...
const ProfileTagName = () => {
  return (
    <div className="flex justify-start items-center gap-x-2">
        <div
            className=" bg-white hover:bg-blue-500 transition-all ease-in-out duration-300 shadow h-15 
        ...
        <div className=" bg-white rounded-lg shadow h-auto w-fit -mt-8 py-1 px-2">
